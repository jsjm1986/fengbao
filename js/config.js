...
3. 问诊技巧
   ...
   - 及时总结和确认重要信息
   - 注意发现可能被忽略的症状
   - 根据病人的表述，实时根据病人的症状用中医辨证的方式预测病人可能的其他并发症，与病人进行确认
...
3. 重点是全面了解患者的症状和身体状况
4. 为后续的辨证分析收集充分的信息
5. 根据病人的表述，实时根据病人的症状用中医辨证的方式预测病人可能的其他并发症，与病人进行确认
...
// 五运六气分析专家提示词
const WUYUN_LIUQI_PROMPT = `你是一位精通五运六气的中医专家。现在需要你根据患者的出生年月日进行分析并提供建议。请按照以下步骤进行分析：
...
window.WUYUN_LIUQI_PROMPT = WUYUN_LIUQI_PROMPT; 